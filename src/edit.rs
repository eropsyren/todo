use crate::constants::{TODO_FILE_NAME, DESCRIPTION, TMP_DIR, EDITOR};
use json::JsonValue;
use std::fs;
...
pub fn edit(id: &str) {
    ...
    let old_description = get_prop_or_exit!(task, DESCRIPTION, JsonValue::String, JsonValue::Short, JsonValue::Object).to_string();
